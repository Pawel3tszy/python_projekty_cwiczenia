...
geek = {"404": "ignorant; od używanego w seci WWW komunikatu o błędzie 404\n\
...
stają się nieaktulane.",
        "Percussive Maintenance": "(konserwacja perkusyjna) naprawa urządzenia \
elektronicznego przez stuknięcie.",
        "Uninstalled": "(odinstalowany) zwolniony z pracy; termin szczególnie \
popularny w okresie bańki internetowej."
        }
...
while choice != "0":
    ...
    # dodaj parę termin-definicja
        ...
        term = input("Jaki termin chcesz dodać?: ")
        if term not in geek:       
